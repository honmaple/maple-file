...
class ListSettingsRequest extends $pb.GeneratedMessage {
  ...
  factory ListSettingsRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory ListSettingsRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListSettingsRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'api.setting'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
...
class ListSettingsResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListSettingsResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'api.setting'), createEmptyInstance: create)
    ..pc<Setting>(1, _omitFieldNames ? '' : 'results', $pb.PbFieldType.PM, subBuilder: Setting.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $core.List<Setting> get results => $_getList(0);
}
